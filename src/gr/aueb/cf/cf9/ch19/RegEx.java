...
public class RegEx {
    ...
    *Character Classes
    ...
    /**
     * Ξεκινάει με uppercase και ακολουθείται από την λέξη coding
     * @param s
     * @return
     */
    ...
    public static boolean twoWords (String s) {
        return s.matches(".*\\s+.*");   //ένας οποισδήποτε χαρακτήρας 0 ή περισσοτερες φορές, ακολουνται κένα 1 ή περισσοτερα και ένας χαρακτήρας 0 ή περισσοτερες φορές
    }
